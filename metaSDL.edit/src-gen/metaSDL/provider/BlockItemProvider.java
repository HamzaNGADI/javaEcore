...
/**
 * This is the item provider adapter for a {@link metaSDL.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Block_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Block_id_feature", "_UI_Block_type"),
						MetaSDLPackage.Literals.BLOCK__ID, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetaSDLPackage.Literals.BLOCK__CANALBLOCK);
			childrenFeatures.add(MetaSDLPackage.Literals.BLOCK__PROCESSUS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetaSDLPackage.Literals.BLOCK__CANALBLOCK,
				MetaSDLFactory.eINSTANCE.createCanalBlock()));

		newChildDescriptors.add(createChildParameter(MetaSDLPackage.Literals.BLOCK__PROCESSUS,
